...
public class SilviculturePlantsRequestDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SilviculturePlantsRequestGlobalFeatureConfigurator.Configure();
        SilviculturePlantsRequestModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SilviculturePlantsRequestDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SilviculturePlantsRequestResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SilviculturePlantsRequest");

            options.DefaultResourceType = typeof(SilviculturePlantsRequestResource);
        ...
        {
            options.MapCodeNamespace("SilviculturePlantsRequest", typeof(SilviculturePlantsRequestResource));
        });
    }
}
