...
public class SilviculturePlantsRequestDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SilviculturePlantsRequestDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
